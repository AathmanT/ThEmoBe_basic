...
def annotate():
    ...
    #     video_file_path = target+'/'+str(id)+'.mp4'
    ...
    id = 1
    video_file_path = target+'/'+str(id)+'.mp4'
    emo_annotation, behav_annotation, threat_annotation = True, True, True

    annotateVideo(APP_ROOT, video_file_path,emo_annotation,behav_annotation,threat_annotation, id)

    # response = {"themobe_id":id,"video":filename,"video_status":"processing"}
    # return jsonify(response)

    print("annotated file saved!!!")
